...
The `plot_cluster_scatter` function creates an overlayed cluster scatter plot with point colouring and cluster centroid labels. It supports `dim_red = "none"`, `"pca"`, `"tsne"`, and `"umap"`.

```{r plot-cluster-scatter}
set.seed(42)
cluster_data <- data.frame(
  cluster = rep(c("A", "B", "C"), each = 15),
  x = rnorm(45),
  y = rnorm(45, mean = rep(c(-1, 0, 1), each = 15))
)
